<script lang="ts" context="module">
   ...
   class SnakeBody {
      ...
      getPosition(bodyPart: HTMLDivElement) {
         ...
         return {
            x: +bodyPart.style.transform
               ...
               .split(",")[0]
               .slice(0, -2),
            y: bodyPart.style.transform.split(",")[1]
               ? +bodyPart.style.transform
                    .split("(")[1]
                    .slice(0, -1)
                    .split(",")[1]
                    .slice(0, -2)
      ...
      setNewHeadPosition() {
         this.head.style.transform = `translate(${
            this.frame.width / 2 - 15
         }px, ${this.frame.height / 2 - 15}px)`;
      }
   ...
   class Apple {
      ...
      constructor(public frame: SnakeFrame, public snake: SnakeBody) {
         this.fruit = this.frame.frame.querySelector(
            "#apple"
         ) as HTMLDivElement;
      ...
      setNewPosition() {
         ...
         do {
            this.fruit.style.transform = `translate(${
               ...
               Math.floor(Math.random() * (this.frame.height / 15)) * 15
            }px)`;
      ...
      movementHandler(event?: KeyboardEvent | Event) {
         ...
         this.interval = setInterval(() => {
            ...
            if (
               ...
               this.apple.fruit.style.transform
            ) {
               this.snake.grow();
               this.apple.setNewPosition();
